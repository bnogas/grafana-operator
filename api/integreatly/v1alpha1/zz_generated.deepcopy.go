...
func (in *GrafanaConfig) DeepCopyInto(out *GrafanaConfig) {
	*out = *in
	...
	if in.AuthJwt != nil {
		in, out := &in.AuthJwt, &out.AuthJwt
		*out = new(GrafanaConfigAuthJwt)
		(*in).DeepCopyInto(*out)
	}
	if in.AuthOkta != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GrafanaConfigAuthJwt) DeepCopyInto(out *GrafanaConfigAuthJwt) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GrafanaConfigAuthJwt.
func (in *GrafanaConfigAuthJwt) DeepCopy() *GrafanaConfigAuthJwt {
	if in == nil {
		return nil
	}
	out := new(GrafanaConfigAuthJwt)
